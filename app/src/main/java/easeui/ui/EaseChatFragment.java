...
import easeui.widget.EaseChatInputMenu.ChatInputMenuListener;
import easeui.widget.EaseChatMessageList;
import easeui.widget.EaseVoiceRecorderView;
import easeui.widget.EaseVoiceRecorderView.EaseVoiceRecorderCallback;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    static final int ITEM_TAKE_PICTURE = 0;
...
//        messageList.setAvatarShape(1);
    ...
    protected void sendTextMessage(String content) {
        if (EaseAtMessageHelper.get().containsAtUsername(content)) {
            ...
            if (String.valueOf(SPUtil.get(getActivity(), "usertype", "")).equals("2")) {
            } else {
                // 增加自己特定的属性
                message.setAttribute("uid", String.valueOf(SPUtil.get(getActivity(), "id", "")));
                message.setAttribute("uname", String.valueOf(SPUtil.get(getActivity(), "account", "")));
            }
            sendMessage(message);
        }
    }
