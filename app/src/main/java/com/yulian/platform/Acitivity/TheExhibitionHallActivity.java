...
import com.yulian.platform.Adapter.ExhibitionAdapter;
import com.yulian.platform.Base.BaseActivity;
import com.yulian.platform.Bean.DescBean;
...
public class TheExhibitionHallActivity extends BaseActivity implements android.view.View.OnClickListener, AdapterView.OnItemClickListener, OnLoadMoreListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        startActivity(new Intent(context, BigImageActivity.class).putExtra("imgurl", UrlUtils.BaseImg + exhibitionBean.getRes().get(position-1).getImgurl()));
    }
